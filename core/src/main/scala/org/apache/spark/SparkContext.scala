...
import org.apache.spark.scheduler.sparrow.{SparrowScheduler, SparrowSchedulerBackend}
  ...
  private def createTaskScheduler(
    ...
    master match {
      ...
      case SPARROW_REGEX(host, port) =>
        val scheduler = new SparrowScheduler(sc, host, port, System.getProperty("sparrow.app.name",
          "spark"))
